    ...
    <div className="flex items-center justify-end gap-5 w-full my-6">
      ...
      <div className="flex items-center space-x-2">
        <Button
          ...
          className="w-9 h-9 flex items-center justify-center border border-primary text-primary disabled:opacity-50 rounded-full"
        ...
        <Button
          ...
          className="w-9 h-9 flex items-center justify-center rounded-full border border-primary text-primary disabled:opacity-50"
